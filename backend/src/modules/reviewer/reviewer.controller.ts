...
export const getCaseTimelineHandler = async (
  req: AuthenticatedRequest,
  res: Response,
  next: NextFunction
): Promise<void> => {
  try {
    ...
    const result = await aiService.getCaseTimeline(caseId, req.user as any);
...
export const getCaseMissingInformationHandler = async (
  req: AuthenticatedRequest,
  res: Response,
  next: NextFunction
): Promise<void> => {
  try {
    ...
    const result = await aiService.getCaseMissingInformation(caseId, req.user as any);
