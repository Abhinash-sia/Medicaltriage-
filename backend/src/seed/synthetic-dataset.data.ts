...
export const SYNTHETIC_CASES: SyntheticCaseData[] = [
  ...
  {
    caseNumber: 'CASE-SYN-URGENT-009',
    patientEmail: 'patient.demo.001@example.test',
    facilityId: 'FAC-DH-CUTTACK',
    chiefComplaint: '6-month-old infant with high fever (104°F), extreme lethargy, and inspiratory stridor',
    narrativeText: 'Pediatric emergency intake: 6-month-old infant presenting with high fever, lethargy, and poor feeding. Facility pediatric critical threshold triggered.',
    priority: CasePriority.URGENT,
    status: CaseStatus.IN_REVIEW,
    category: 'URGENT',
    ruleTrigger: 'Configured pediatric critical threshold',
    language: 'hi',
    assignedReviewerEmail: 'doctor.demo.001@example.test',
    hoursAgo: 0.3,
  },
  {
    caseNumber: 'CASE-SYN-URGENT-010',
    patientEmail: 'patient.demo.002@example.test',
    facilityId: 'FAC-DH-CUTTACK',
    chiefComplaint: 'Clinician-configured critical lab alert: Serum Potassium 7.1 mmol/L (Hyperkalemia)',
    narrativeText: 'Automated critical lab values flagged from uploaded report: Potassium 7.1 mmol/L (threshold GT 6.5 mmol/L). High risk of cardiac arrhythmia.',
    priority: CasePriority.URGENT,
    status: CaseStatus.IN_REVIEW,
    category: 'URGENT',
    ruleTrigger: 'Clinician-configured critical lab threshold',
    language: 'or',
    assignedReviewerEmail: 'doctor.demo.001@example.test',
    hoursAgo: 0.5,
  },
